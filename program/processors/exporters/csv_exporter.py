...
def write_csv(processor_result: ProcessorResult, output_write_config: OutputWriteOption):
  csv_file = Path(output_write_config.base_directory) / f"{processor_result.query_name}.csv"
